package com.java.practice.datastruc.tree.search;
...
/**
 * AVL树是最早被发明的自平衡二叉查找树 (最早的平衡二叉树)
 * 它的查询时间复杂度可以保证是O（log n）
 * <p>
 * 任意一个结点的key，比它的左孩子key大，比它的右孩子key小；
 * 任意结点的孩子结点之间高度差距最大为1；
 * <p>
 * 实现原理：
 * 平衡二叉树构建的基本思想就是在构建二叉排序树的过程中，每当插入一个节点时，先检查是否因插入而破坏了树的平衡性，若是，找出最小不平衡树。
 ...
 * <p>
 * https://www.cnblogs.com/lishanlei/p/10707794.html
...
class AVLTreeTests {
    ...
    static class AVLNode {
        ...
        AVLNode(AVLNode parent, AVLNode leftChild, AVLNode rightChild, int data) {
            this.parent = parent;
        ...
        AVLNode(AVLNode parent, int data) {
            this.parent = parent;
            this.data = data;
        }
    }
    ...
    @DisplayName("平衡二叉树")
    void test() {
        AVLTreeTests bbt = new AVLTreeTests();
        bbt.put(3);
        bbt.put(2);
        bbt.put(1);
        bbt.put(4);
