package com.java.practice.algorithm.ciphers;
...
public class AESTests {
    ...
    static class AES {
         ...
         * @return
         */
        static BigInteger scheduleCore(BigInteger t, int rconCounter) {
         ...
         */
        static BigInteger[] keyExpansion(BigInteger initialKey) {
         ...
         */
        static int[] splitBlockIntoCells(BigInteger block) {
         ...
         */
        static BigInteger mergeCellsIntoBlock(int[] cells) {
